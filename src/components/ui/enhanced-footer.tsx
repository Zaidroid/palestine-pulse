/**
 * Enhanced Footer Component - Compact Version
 * 
...
export interface DataSourceStatus {
  ...
  message?: string;
  description?: string;
  updateMethod?: 'github-actions' | 'web-scraping' | 'api';
...
const GITHUB_ACTIONS_INTERVAL = 6 * 60 * 60 * 1000; // 6 hours in milliseconds
...
export const EnhancedFooter: React.FC<EnhancedFooterProps> = ({
  dataSources,
  lastUpdated,
  onRefresh,
  className
                        ...
                        <div className="space-y-1.5 pt-2 border-t">
                          ...
                          {source.quality && (
                            <div className="flex items-center justify-between text-xs">
                              ...
                              <Badge
                                variant={source.quality === 'high' ? 'success' : source.quality === 'medium' ? 'warning' : 'destructive'}
